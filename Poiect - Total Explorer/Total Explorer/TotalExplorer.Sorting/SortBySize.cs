...
namespace TotalExplorer.Sorting
{
    ...
    {
        /// <summary>
        /// Sorts a list of <see cref="FileItem"/> objects by file size.
        /// </summary>
        /// <param name="files">The list of files to sort.</param>
        /// <param name="descending">
        /// Indicates whether the sorting should be in descending order.
        /// <c>true</c> = largest first, <c>false</c> = smallest first (default).
        /// </param>
        /// <returns>A new list of <see cref="FileItem"/> objects sorted by size.</returns>
